...
# 0 for webcam feed; add "path to file" for detection in a video file
...
while True:
    ...
    # Check if the face cascade classifier is empty
    ...
    if (eye_1[0] is not None) and (eye_2[0] is not None):
        ...
        # on either side, the program will classify it as right or left tilt)
        if angle > 10:
